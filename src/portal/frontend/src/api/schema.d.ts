...
export interface paths {
    ...
    "/api/v1/mcp/connections/{connectionID}/probe": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: {
            ...
            requestBody?: never;
            responses: {
                /** @description MCP protocol probe result, including compatibility or authorization status */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                /** @description Probe persistence unavailable */
                503: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/api/v1/mcp/connections/{connectionID}/grants": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/mcp/connections/{connectionID}/policies": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/mcp/connections/{connectionID}/oauth": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put: {
            ...
            responses: {
                /** @description OAuth client configured */
                204: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/api/v1/mcp/connections/{connectionID}/oauth/connect": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/mcp/proxy/{slug}": {
        ...
        post: {
            ...
            responses: {
                ...
                /** @description Not granted or denied by policy */
                403: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/api/v1/mcp/audit": {
        ...
        get: {
            ...
            requestBody?: never;
            responses: {
                /** @description Inspected MCP messages */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
